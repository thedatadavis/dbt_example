with schedule as (
    ...
    from {{ ref('stg_raw__calendar') }} as calendar
    left join {{ ref('int_listing_dates_grouped') }} as listing_dates 
...
full_listings as (
    ...
    left join {{ ref('int_listing_has_amenities') }} as listing_amenities
        using(listing_id)
